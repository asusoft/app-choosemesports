...
export function genAudio (): { name: string, type: string, uri: string } {

    const filename = genString(30);

    const placeholderUri = `/Users/ashehu/development/sautul-ulama/backend/tests/__tests__/files/test-audio.mp3`;
