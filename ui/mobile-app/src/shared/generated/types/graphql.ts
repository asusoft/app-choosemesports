...
export type SimplePlayerFragment = { __typename?: 'Player', id: string, userID: string, sport?: { __typename?: 'Sport', id: string, name: string } | null, positions?: Array<{ __typename?: 'PlayerPosition', name: string, stats: Array<{ __typename?: 'PlayerPosStat', label: string, value: string }> }> | null };
